...
function PrivacyPage() {
  return (
    <LegalShell title="Privacy Policy" eyebrow="Legal" updated="April 1, 2026">
      <p>This privacy policy explains what information Yosemite Sentinel collects when you visit this website or subscribe to the newsletter, how that information is used, and the choices you have about it. It is written to comply with the General Data Protection Regulation (GDPR) and the California Consumer Privacy Act (CCPA).</p>

      <h2>1. Who we are</h2>
      <p>Yosemite Sentinel is an independent publication operated by Parker Woods, based in El Portal, California. You can reach us at parker@yosemitesentinel.com.</p>
...
function TermsPage() {
  return (
    <LegalShell title="Terms of Service" eyebrow="Legal" updated="April 1, 2026">
      <p>These terms govern your use of Yosemite Sentinel (yosemitesentinel.com). By using the site, you agree to them.</p>
      ...
      <p>To the fullest extent permitted by law, Yosemite Sentinel is not liable for any injury, loss, or damage arising from your use of this site or your activities in Yosemite National Park. The mountains are real. Walk carefully.</p>
...
function AffiliatePage() {
  return (
    <LegalShell title="Affiliate Disclosure" eyebrow="Legal" updated="April 1, 2026">
      <p>Yosemite Sentinel is a participant in several affiliate programs, including Amazon Associates, Bookshop.org, REI's affiliate program, and a small number of guidebook publishers' direct programs.</p>
